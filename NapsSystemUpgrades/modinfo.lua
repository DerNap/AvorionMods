...
meta =
{
    ...
    name = "ImprovedCoProcessorUnits",

    -- Title of your mod that will be displayed to players
    title = "Nap's Role-based Co-Processor Unit System Upgrades",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds various role-based Co-Processor CPU enhancements to the game adding up some key features that help to fill that role more efficiently. Can only be found in the center of the galaxy.",

    -- Insert all authors into this list
    authors = {"avorion-addicts"},
