...
meta =
{
    ...
    name = "GemAndDiamondMine",

    -- Title of your mod that will be displayed to players
    title = "Gem and Diamond Mines",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "In its current state of the game, stations or mines can neither produce gems nor diamonds. With this mod you will be able to found gem and diamond mines from claimable asteroids.",
